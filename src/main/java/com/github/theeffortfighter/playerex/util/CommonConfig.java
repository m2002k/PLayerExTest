	...
	public static class Common {
		...
		public Common(ForgeConfigSpec.Builder par0) {
			...
			this.constitution = par0
					.comment("Starting Constitution (Starting HP in half hearts) - cannot and should not be set to 0 or less than 0.")
			...
			par0.pop();
			par0.comment("Options to disable/enable modifiers").push("functions");
